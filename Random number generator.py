...
minusing=int(int(splitNumberRange[1])+1)-1
dividingNumber=int(int(splitNumberRange[1])+1)
print("There is a "+str(100/dividingNumber)+"% chance of each number generating.")
print(number)